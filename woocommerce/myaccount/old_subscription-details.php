...
?>
        ...
        <tr>
            ...
            foreach ($actions as $key => $action) :
                ...
                ?>
                <a href="<?php echo esc_url($action['url']); ?>" class="<?php echo trim(implode(' ', $classes)); ?>">
        ...
        <tr>
            <!-- Show the "Resubscribe" button unconditionally -->
            <a href="<?php echo esc_url(add_query_arg(['resubscribe' => $subscription->get_id()], wc_get_account_endpoint_url('subscriptions'))); ?>"
                class="button resubscribe wcs_block_ui_on_click">
                <?php esc_html_e('Resubscribe', 'woocommerce-subscriptions'); ?>
            </a>
        </tr>
